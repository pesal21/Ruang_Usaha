    ...
    <main class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        <div class="grid md:grid-cols-2 gap-10 items-center w-full max-w-6xl">
            ...
            <div class="hidden md:flex justify-center">
                <img src="{{ asset('gambar-1.png') }}" class="w-[400px] lg:w-[480px] float-animation drop-shadow-2xl"
            ...
            <div class="w-full max-w-md mx-auto bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl shadow-blue-100 
                ...
                <div class="flex bg-gray-100 rounded-full p-1 mb-8">
                    <a href="{{ route('login.role', ['role' => 'admin']) }}"
                       class="w-1/2 text-center py-2.5 font-semibold text-sm rounded-full transition-all duration-300
                              {{ $role == 'admin' ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-200' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-700' }}">
                        Admin
                    </a>
                    <a href="{{ route('login.role', ['role' => 'umkm']) }}"
                       class="w-1/2 text-center py-2.5 font-semibold text-sm rounded-full transition-all duration-300
                              {{ $role == 'umkm' ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-200' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-700' }}">
                        Pelaku UMKM
                    </a>
                </div>
                ...
                <form method="POST" action="{{ route('login.process') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-blue-500">
                                <img src="{{ asset('assets/img/icon_umkm/people.png') }}" alt="icon" class="w-5 h-5 object-contain">
                            </span>
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-blue-500">
                                <img src="{{ asset('assets/img/icon_umkm/lock.png') }}" alt="icon" class="w-5 h-5 object-contain">
                            </span>
