...
<head>
    <meta charset="UTF-8">
    <title>{{ $blog->judul }} – RuangUsaha</title>
...
<body class="bg-white text-gray-800">
    ...
    <!-- CONTENT -->
    <main class="max-w-2xl mx-auto px-6 pt-24 pb-20">

        <!-- BACK -->
        <a href="{{ route('blog.index') }}"
            class="inline-flex items-center gap-1 text-blue-600 text-sm hover:underline mb-6">
            < Kembali
                </a>

                <!-- JUDUL -->
                <h1 class="text-3xl font-bold text-gray-900 leading-tight mb-4 text-left">
                    {{ $blog->judul }}
                </h1>

                <!-- META: TANGGAL + KATEGORI/SUMBER -->
                <div class="flex items-center gap-4 text-xs text-gray-400 mb-6">
                    <span class="flex items-center gap-1">
                        <img src="{{ asset('assets/img/icon_umkm/calendar.svg') }}" alt="calendar" class="w-3 h-3">
                ...
                <!-- ISI ARTIKEL -->
                <div class="text-gray-700 text-sm leading-relaxed text-justify space-y-4 whitespace-pre-line">
                    {{ $blog->isi }}
                </div>
