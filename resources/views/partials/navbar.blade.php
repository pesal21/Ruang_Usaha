...
<nav x-data="{ mobileOpen: false }" class="fixed top-0 w-full bg-white/90 backdrop-blur-lg z-50 shadow-sm border-b border-blue-100/50">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-1">
                <a href="{{ route('beranda') }}"
                   class="nav-link px-3 py-2 text-sm {{ request()->routeIs('beranda') ? 'nav-link-active' : 'text-gray-600 hover:text-blue-600' }} transition-colors duration-200">
                ...
                <a href="{{ route('umkm.index') }}"
                   class="nav-link px-3 py-2 text-sm {{ request()->routeIs('umkm.index') ? 'nav-link-active' : 'text-gray-600 hover:text-blue-600' }} transition-colors duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <a href="{{ route('umkm.pilih') }}"
                   class="nav-link px-3 py-2 text-sm {{ request()->routeIs('umkm.pilih') ? 'nav-link-active' : 'text-gray-600 hover:text-blue-600' }} transition-colors duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <a href="{{ route('blog.index') }}"
                   class="nav-link px-3 py-2 text-sm {{ request()->routeIs('blog.index') ? 'nav-link-active' : 'text-gray-600 hover:text-blue-600' }} transition-colors duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="py-1.5">
                            ...
                            @if(auth()->user()->umkm)
                            <a href="{{ route('umkm.dashboard', auth()->user()->umkm->id) }}" 
                               class="dropdown-item flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50/60 transition-all duration-200">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
    ...
    <div x-show="mobileOpen" 
        ...
        <div class="px-4 py-3 space-y-1">
            <a href="{{ route('beranda') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm {{ request()->routeIs('beranda') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-blue-50/60 hover:text-blue-600' }} transition-all duration-200">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
                Beranda
            ...
            <a href="{{ route('umkm.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm {{ request()->routeIs('umkm.index') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-blue-50/60 hover:text-blue-600' }} transition-all duration-200">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0H5m14 0h2M5 21H3M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                </svg>
                Daftar UMKM
            ...
            @auth
            <a href="{{ route('umkm.pilih') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm {{ request()->routeIs('umkm.pilih') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-blue-50/60 hover:text-blue-600' }} transition-all duration-200">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                Pilih UMKM
            ...
            @endauth
            <a href="{{ route('blog.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm {{ request()->routeIs('blog.index') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-blue-50/60 hover:text-blue-600' }} transition-all duration-200">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                </svg>
                Blog
