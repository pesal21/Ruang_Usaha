...
<body class="bg-white text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-6 pt-28 pb-16">
        ...
        <!-- HEADER -->
        <div class="mb-10">
            <h1 class="text-3xl font-bold">Pilih UMKM</h1>
            <p class="text-gray-500 mt-1">Pilih usaha yang ingin kamu kelola</p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <a href="{{ route('umkm.dashboard', $umkm->id) }}"
                class="bg-white border rounded-xl p-5 shadow-sm hover:shadow-lg transition hover:-translate-y-1">

                <!-- LOGO -->
                <div class="w-16 h-16 mx-auto mb-4 rounded-full overflow-hidden flex items-center justify-center
                {{ $umkm->logo ? 'bg-gray-100' : 'bg-blue-600 text-white' }}">
