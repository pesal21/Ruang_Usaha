...
<body class="hero-bg noise text-gray-800 antialiased min-h-screen">
    ...
    {{-- ── MAIN CONTENT ── --}}
    <main class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 page-enter">
        ...
        <div class="text-center mb-10 card-animate" style="animation-delay: 0.15s;">
            ...
            <p class="text-gray-500 mt-3 max-w-md mx-auto text-sm md:text-base">
                Perbarui informasi dan foto produk usaha Anda.
            </p>
            ...
            <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="5"
                            ...
                            class="input-field w-full border-2 border-blue-100 rounded-2xl py-3 px-4 text-sm
                                     ...
                                     font-medium resize-none">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="drag-area rounded-2xl p-8 text-center cursor-pointer"
                        ...
                        <div id="uploadPlaceholder" class="{{ $produk->foto_produk ? 'hidden' : '' }}">
                        ...
                        {{-- Preview foto --}}
                        <div id="uploadPreview" class="{{ $produk->foto_produk ? '' : 'hidden' }}">
                            <img id="previewImg"
                                src="{{ $produk->foto_produk ? asset('storage/'.$produk->foto_produk) : '' }}"
                                alt="Preview"
                                class="max-h-48 mx-auto rounded-xl object-contain shadow-sm">
                            <p id="fileName" class="text-xs text-gray-500 mt-3 font-medium">
                                {{ $produk->foto_produk ? basename($produk->foto_produk) : '' }}
                            </p>
                    ...
                    <p class="text-xs text-gray-400 mt-3 text-center">
                        Kosongkan jika tidak ingin mengganti foto produk.
                    </p>
                </div>
            </form>
