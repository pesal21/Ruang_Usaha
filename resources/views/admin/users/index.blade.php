                    ...
                    <tr class="border-t border-gray-50 hover:bg-blue-50/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold ring-1 ring-inset
                                @if($user->status === 'active') bg-green-50 text-green-700 ring-green-600/20
                                @else bg-orange-50 text-orange-700 ring-orange-600/20 @endif">
                                {{ ucfirst($user->status) }}
                            </span>
                        </td>
                            ...
                            <div
                                ...
                                <a href="{{ route('admin.user.show', $user->id) }}"
                                   class="block w-full text-left px-4 py-2.5 text-sm text-gray-700
                                    ...
                                    <img src="{{ asset('assets/img/icon_umkm/eye.svg') }}" alt="" class="w-4 h-4 inline mr-2">
                                    View Details
                                </a>
                                ...
                                <form action="{{ route('admin.user.suspend', $user->id) }}" method="POST"
                                    ...
                                    <button type="submit"
                                        ...
                                        <img src="{{ asset('assets/img/icon_umkm/suspend.svg') }}" alt="" class="w-4 h-4 inline mr-2">
                                        Suspend User
                                    </button>
                                </form>
                                @else
