                    ...
                    <tr class="border-t border-gray-50 hover:bg-blue-50/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium text-gray-800"><?php echo e($umkm->nama_usaha); ?></span>
                            </div>
                        </td>
    ...
    <?php echo e(ucfirst($umkm->status)); ?>
                        ...
                        <td class="px-6 py-4 text-right relative" x-data="{ open: false }">
                            ...
                            <div
                                ...
                                <a href="<?php echo e(route('admin.umkm.detail', $umkm->id)); ?>"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/admin/umkm/data.blade.php ENDPATH**/ ?>