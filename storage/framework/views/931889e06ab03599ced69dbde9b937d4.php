        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-16 grid md:grid-cols-2 gap-12 items-center pb-16">
            ...
            <div class="z-10" data-aos="fade-right" data-aos-duration="700">
                ...
                <div class="flex flex-wrap gap-3 mt-8">
                    ...
                    <a href="<?php echo e(route('login.role', 'umkm')); ?>"
                    ...
                    <a href="<?php echo e(auth()->user()->umkm ? route('umkm.pilih') : route('umkm.create')); ?>"
                       class="btn-shimmer inline-flex items-center gap-2 px-7 py-3.5
                              bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold
                              rounded-2xl shadow-xl shadow-orange-400/30 hover:shadow-orange-400/50
                              hover:-translate-y-0.5 active:scale-95 transition-all duration-200 text-sm">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-16">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
                ...
                ?>
                <a href="<?php echo e(route('umkm.show', $umkm->id)); ?>"
                   ...
                   data-aos="zoom-in" data-aos-delay="<?php echo e(min($loop->index * 50, 350)); ?>">
                    ...
                    <div class="logo-ring w-16 h-16 rounded-2xl mb-3 flex items-center justify-center
                        ...
                        <?php if($umkm->logo): ?>
                            <img src="<?php echo e(asset('storage/'.$umkm->logo)); ?>"
                                 class="w-full h-full object-cover" alt="<?php echo e($umkm->nama_usaha); ?>">
                        <?php else: ?>
                    ...
                    <?php if($umkm->kategori_usaha): ?>
                    <span class="mt-1.5 text-xs text-gray-400 font-medium"><?php echo e($umkm->kategori_usaha); ?></span>
                    <?php endif; ?>
                </a>
    ...
    <section class="py-20 bg-orange-50">
        <div class="max-w-7xl mx-auto px-6 lg:px-16">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <?php $s = $katStyles[$loop->index % count($katStyles)]; ?>

                <div class="kat-card <?php echo e($s['card_bg']); ?> rounded-2xl border border-gray-100 shadow-sm
                            hover:shadow-lg hover:border-gray-200 p-6 flex items-start gap-4
                            cursor-default"
                     data-aos="fade-up" data-aos-delay="<?php echo e(min($loop->index * 80, 320)); ?>">

                    <div class="w-14 h-14 flex-shrink-0 rounded-2xl flex items-center justify-center
                                <?php echo e($s['icon_bg']); ?> shadow-sm <?php echo e($s['icon_txt']); ?>">
                        <?php if($kategori->icon): ?>
                            <img src="<?php echo e(asset('storage/'.$kategori->icon)); ?>" class="w-8 h-8 object-contain">
                        <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap mb-1.5">
                            <h3 class="font-bold text-gray-900 text-base"><?php echo e($kategori->nama); ?></h3>
                            <?php if(isset($kategori->umkms_count)): ?>
                            <span class="text-xs px-2 py-0.5 rounded-full font-semibold <?php echo e($s['badge']); ?>">
                                <?php echo e($kategori->umkms_count); ?> usaha
                            </span>
                            <?php endif; ?>
                        </div>
                        <p class="text-gray-500 text-sm leading-relaxed line-clamp-2">
                            <?php echo e($kategori->deskripsi ?? 'Kategori usaha lokal di Bontang.'); ?>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-16">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-12">
                ...
                <a href="<?php echo e(route('blog.index')); ?>" data-aos="fade-left"
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <?php $bh = $blogHeaders[$loop->index % count($blogHeaders)]; ?>
                <article class="blog-card card-animate group bg-white rounded-2xl border border-gray-100 shadow-md
                    ...
                    <div class="blog-img-overlay card-img-wrap h-44 relative overflow-hidden">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full bg-gradient-to-br <?php echo e($bh['bg']); ?>
                        ...
                        <?php endif; ?>
                        <span class="absolute bottom-3 left-4 text-xs font-bold px-2.5 py-1 rounded-full <?php echo e($bh['tag_bg']); ?>">
                            <?php echo e($bh['tag']); ?>
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed line-clamp-3">
                            <?php echo e(\Illuminate\Support\Str::limit($blog->isi, 90)); ?>

                        </p>
                        <a href="<?php echo e(route('blog.show', $blog->id)); ?>" class="link-anim inline-flex items-center gap-1 mt-4 text-orange-600
