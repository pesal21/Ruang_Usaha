                    ...
                    <tr class="border-t border-gray-50 hover:bg-blue-50/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="<?php echo e(route('admin.blog.delete', $blog->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>