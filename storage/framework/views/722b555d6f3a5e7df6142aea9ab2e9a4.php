            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <p class="text-xs text-gray-400">
                        <?php echo e(auth()->user()->profile_picture ? 'Foto profil saat ini' : 'Belum ada foto profil'); ?>
                ...
                <div>
                    <form method="POST" action="<?php echo e(route('profile.picture')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/profile/index.blade.php ENDPATH**/ ?>