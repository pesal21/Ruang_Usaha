...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($umkm->nama_usaha); ?> – RuangUsaha</title>
    ...
    <main class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 border border-blue-100 rounded-xl px-4 py-3
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($umkm->nama_usaha . ' ' . $umkm->alamat_lengkap . ' Bontang Kalimantan Timur')); ?>"
                            target="_blank"
                            class="block text-sm font-semibold text-gray-700 hover:text-blue-600 hover:underline">

                                <?php echo e($umkm->alamat_lengkap ?? 'Lokasi tidak tersedia'); ?>
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                <?php $__currentLoopData = $umkm->produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/umkm/show.blade.php ENDPATH**/ ?>