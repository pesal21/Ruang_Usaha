    ...
    <main class="relative z-10 flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 mt-4 max-w-lg mx-auto text-base leading-relaxed">
                Atur produk dan galeri foto untuk usaha <span class="font-semibold text-blue-600"><?php echo e($umkm->nama_usaha); ?></span>.
            </p>
        ...
        <div class="grid lg:grid-cols-2 gap-10">
            ...
            <section>
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                    ...
                    <a href="<?php echo e(route('umkm.produk.create', $umkm->id)); ?>"
                ...
                <div class="space-y-3">
                    ...
                    <div class="product-card card-animate bg-white rounded-2xl border border-gray-100
                        ...
                        <div class="product-img-wrap w-16 h-16 rounded-xl flex-shrink-0 overflow-hidden
                            ...
                            <img src="<?php echo e(asset('storage/'.$item->foto_produk)); ?>"
                                class="w-full h-full object-cover" alt="<?php echo e($item->nama_produk); ?>">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-bold text-gray-800 text-sm truncate"><?php echo e($item->nama_produk); ?></h3>
                            <?php if($item->kategori ?? false): ?>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($item->kategori); ?></p>
                            <?php endif; ?>
                            <?php if($item->harga): ?>
            ...
            <section>
                ...
                <form action="<?php echo e(route('umkm.galeri.store', $umkm->id)); ?>"
                    method="POST"
                ...
                <?php if(isset($umkm->galeri) && $umkm->galeri->count()): ?>
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    ...
                    <div class="gallery-card card-animate rounded-2xl border border-gray-100
                        ...
                        <form action="<?php echo e(route('umkm.galeri.destroy', $foto->id)); ?>" method="POST"
...
</html><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/umkm/kelola-produk-foto.blade.php ENDPATH**/ ?>