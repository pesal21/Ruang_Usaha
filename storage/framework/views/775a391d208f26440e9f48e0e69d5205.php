        ...
        <form action="<?php echo e(route('admin.blog.store')); ?>" method="POST"
            ...
            <div>
                ...
                <textarea name="isi" rows="12" required
                    ...
                    class="w-full border-2 border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white
                           focus:outline-none focus:border-blue-400 focus:shadow-[0_0_0_4px_rgba(59,130,246,0.15)]
                           hover:border-blue-300 transition-all duration-200 resize-none placeholder:text-gray-400"><?php echo e(old('isi')); ?></textarea>
            </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>