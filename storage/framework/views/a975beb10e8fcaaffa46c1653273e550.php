...
<body class="hero-bg noise text-gray-800 antialiased min-h-screen">
    ...
    <main class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24">
        ...
        <div class="detail-card card-animate bg-white rounded-3xl border border-gray-100 shadow-md shadow-blue-50
            ...
            <div class="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                ...
                <div class="shrink-0 w-28 h-28 sm:w-32 sm:h-32 rounded-2xl bg-gradient-to-br from-blue-50 via-sky-50 to-teal-50
                    ...
                    <?php if($umkm->logo): ?>
                    <img src="<?php echo e(asset('storage/' . $umkm->logo)); ?>" class="w-full h-full object-cover"
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm text-gray-500 mt-3 leading-relaxed text-justify">
                        <?php echo e($umkm->deskripsi ?? 'Tidak ada deskripsi.'); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 border border-blue-100 rounded-xl px-4 py-3
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-semibold text-gray-700 truncate"><?php echo e($umkm->kategori->nama ?? '-'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 border border-blue-100 rounded-xl px-4 py-3
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-semibold text-gray-700 truncate"><?php echo e($umkm->alamat_lengkap ?? '-'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 border border-blue-100 rounded-xl px-4 py-3
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-semibold text-gray-700 truncate"><?php echo e($umkm->jam_operasional ?? '-'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 border border-blue-100 rounded-xl px-4 py-3
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-semibold text-gray-700 truncate"><?php echo e($umkm->kontak ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if(auth()->user()->id === $umkm->user_id): ?>
            <div class="flex flex-wrap gap-3 mt-6 pt-6 border-t border-gray-100">
                <a href="<?php echo e(route('umkm.edit', $umkm->id)); ?>"
            ...
            <div class="flex flex-wrap gap-3 mt-6 pt-6 border-t border-gray-100">
                ...
                <form method="POST" action="<?php echo e(route('admin.umkm.approve', $umkm->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                ...
                <form method="POST" action="<?php echo e(route('admin.umkm.reject', $umkm->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                ...
                <form method="POST" action="<?php echo e(route('admin.umkm.suspend', $umkm->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                ...
                <?php if($umkm->status === 'suspended'): ?>
                <form method="POST" action="<?php echo e(route('admin.umkm.activate', $umkm->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                        class="btn-shimmer inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-500
                               text-white font-semibold rounded-xl shadow-md shadow-green-100
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                <div class="product-card card-animate bg-white rounded-2xl border border-gray-100
                    ...
                    <div class="product-img-wrap relative h-36 bg-gradient-to-br from-blue-50 via-sky-50 to-teal-50
                        ...
                        <img src="<?php echo e(asset('storage/'.$p->foto_produk)); ?>"
                    ...
                    <div class="p-3.5 flex flex-col flex-1 gap-2">
                        ...
                        <p class="text-xs text-gray-400 font-medium"><?php echo e($p->kategori); ?></p>
                        <?php endif; ?>
        ...
        <?php if(isset($umkm->galeri) && $umkm->galeri->count() > 0): ?>
        <section>
            <div class="flex items-center gap-3 mb-6">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-teal-100
                            flex items-center justify-center shadow-sm">
                ...
                <span class="text-xs bg-blue-100 text-blue-600 px-2.5 py-1 rounded-full font-semibold">
                    <?php echo e($umkm->galeri->count()); ?>

                </span>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <?php $__currentLoopData = $umkm->galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
