...
<div class="max-w-2xl mx-auto mb-10">
    <form method="GET" action="<?php echo e(route('blog.index')); ?>" class="relative group">
...
class="search-input w-full pl-12 pr-14 py-4 border-2 border-blue-100
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <div class="card-img-wrap relative h-44 bg-gradient-to-br from-blue-50 via-sky-50 to-teal-50 flex items-center justify-center flex-shrink-0">
        <?php if($blog->gambar): ?>
...
<p class="text-xs text-gray-500 line-clamp-3 leading-relaxed">
    <?php echo e(\Illuminate\Support\Str::limit($blog->konten ?? $blog->isi ?? '', 120)); ?>
...
<?php if($blogs instanceof \Illuminate\Contracts\Pagination\Paginator && $blogs->hasPages()): ?>
...
</html><?php /**PATH D:\KULIAH\TUGAS KULIAH\Sem 6\Produk Perangkat Lunak\UMKM-Bontang\resources\views/blog/index.blade.php ENDPATH**/ ?>