...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($produk->nama_produk); ?> – RuangUsaha</title>
        ...
        function goBack() {
            ...
            if (referrer) {
                ...
                if (window.history.length > 1) {
                    ...
                    window.location.href = '<?php echo e(route("umkm.index")); ?>';
                }
            }
        }
    </script>
    ...
    <main class="relative z-10 flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 page-enter">
        ...
        <div class="grid lg:grid-cols-3 gap-10 mb-16">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-50 shadow-lg shadow-blue-50/50 overflow-hidden">
                    <div class="w-full aspect-square bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 flex items-center justify-center overflow-hidden">
                        <?php if($produk->foto_produk): ?>
                            <img id="mainImage" src="<?php echo e(asset('storage/'.$produk->foto_produk)); ?>"
            ...
            <div class="lg:col-span-2 animate-fade-up" style="animation-delay: 0.2s;">
                ...
                <div class="mb-6 flex items-center gap-2 text-sm text-gray-500 flex-wrap">
                    <a href="<?php echo e(route('umkm.index')); ?>" class="hover:text-blue-600 transition-colors font-medium">Produk</a>
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span class="text-gray-700 font-semibold truncate"><?php echo e($produk->nama_produk); ?></span>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                        <p class="text-gray-600 leading-relaxed text-justify">
                            <?php echo e($produk->deskripsi ? trim($produk->deskripsi) : 'Tidak ada deskripsi untuk produk ini.'); ?>
        ...
        <section class="animate-fade-up" style="animation-delay: 0.25s;">
            <div class="mb-8">
                ...
                <p class="text-gray-500 ml-13">Produk lainnya dari <?php echo e($umkm->nama_usaha); ?></p>
            </div>

            <?php if($rekomendasi->count()): ?>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                    <?php $__currentLoopData = $rekomendasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
